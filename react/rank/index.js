...
class App extends Component {
  ...
  render() {
      ...
      if (offline) {
        return (
          <img
            ...
            className="reload"
            width="50%"
            onClick={this.handleAfter.bind(this, index + 1)}
          />
        );
    ...
    if (!offline && Object.keys(myinfo).length) {
      let info, myranking;
      myranking = parseInt(myinfo.myanswercount) === 0
        ? '暂无'
        : myinfo.myranking;
        ...
        <div className="nobodybottom">
          <dl>
            ...
            <dd className="fl inforwrap">
              <p className="infor">
                {myinfo.MyAgentName || myinfo.username}丨 {myinfo.MyComName}
              </p>
    ...
    return (
      <div>
        ...
        <Tabs
          className="wrap"
          tabActive={this.state.currentTabIndex}
