...
import { areas, stations } from '../../../mock/search';
    ...
    return (
      <div className="side-menu" style={this.state.showCondition ? {} : fold}>
        <h3
          ...
          className={this.state.showCondition ? '' : 'arrdown'}
        >
          快速找房
        </h3>
        <ul className="side-menu-list">
          {data.map((item, index) => <Item key={index} {...data[index]} />)}
        </ul>
