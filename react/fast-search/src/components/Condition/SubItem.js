...
export default class SubItem extends Component {
  ...
  render() {
    ...
    return (
      <li
        className={this.state.showOption ? 'on' : ''}
      ...
      >
        ...
        {letter &&
          <div
            className="draw-info"
            style={this.state.showOption ? show : hide}
          >
                    ...
                    return (
                      <li key={index}>
                        {temparr.map((t, index) => (
                          <dl
                            key={index}
                            className={index === 0 ? 'floatl' : 'floatr'}
                          >
                  ...
                  {s.map((ss, index) => (
                    <li key={index}>
                      <a
                        ...
                        target="_blank"
                      >
                        <span className="icon-line" />{ss.Name}
                      </a>
                    </li>
                  ))}
                </ul>
